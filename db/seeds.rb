...
Item.create(
  ...
  race: "Scottish",
  image_url: "https://images.pexels.com/photos/96428/pexels-photo-96428.jpeg?auto=compress&cs=tinysrgb&dpr=2&w=500",
  price: prices.sample,
...
Item.create(
  ...
  image_url: "https://images.pexels.com/photos/45201/kitty-cat-kitten-pet-45201.jpeg?auto=compress&cs=tinysrgb&dpr=2&w=500",
  price: prices.sample,
  photographer: Faker::Name.name
)
...
Item.create(
  ...
  race: "Maine Coon",
  image_url: "https://images.pexels.com/photos/2194261/pexels-photo-2194261.jpeg?auto=compress&cs=tinysrgb&dpr=2&w=500",
  price: prices.sample,
  photographer: Faker::Name.name,
)
...
Item.create(
  ...
  race: "Snowshoe",
  image_url: "https://images.pexels.com/photos/127027/pexels-photo-127027.jpeg?auto=compress&cs=tinysrgb&dpr=2&w=500",
  price: prices.sample,
  photographer: Faker::Name.name
)
...
Item.create(
  ...
  race: "Maine Coon",
  image_url: "https://images.pexels.com/photos/1183434/pexels-photo-1183434.jpeg?auto=compress&cs=tinysrgb&dpr=2&w=500",
  price: prices.sample,
  photographer: Faker::Name.name
)
...
Item.create(
  ...
  race: "Bengale",
  image_url: "https://images.pexels.com/photos/1870376/pexels-photo-1870376.jpeg?auto=compress&cs=tinysrgb&dpr=2&w=500",
  price: prices.sample,
  photographer: Faker::Name.name
)
...
Item.create(
  ...
  race: "Caracal",
  image_url: "https://cdn.lelynx.fr/wp-content/uploads/2020/05/GettyImages-1214907564.jpg",
  price: prices.sample,
  photographer: Faker::Name.name
)
